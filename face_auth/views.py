...
from .forms import RegistrationForm,LoginForm,BookingForm, ContactForm
from .models import User,Departments,Doctors
...
def homepage(request):
    ...
    return render(request, 'homepage.html', dict_docs)
